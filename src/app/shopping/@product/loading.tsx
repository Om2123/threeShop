  ...
  return (
    <div>
      <div>
        ...
        <div className='flex  animate-pulse hover:shadow-2xl w-item-height shadow-lg mb-10'>

          <div      >
            <div className=" md:basis-1/3  bg-stone-700 rounded-md m-1">
              {/* product image */}
              <div className="flex items-center justify-center w-full h-48 bg-gray-800 rounded sm:w-96 dark:bg-gray-700">
          ...
          <div className='w-full m-1 ml-6'>
            ...
            <div className="text-xl p-2">
              Rs.         <div className="h-2.5 bg-gray-700 rounded-full dark:bg-gray-700 w-48 mb-4"></div>
