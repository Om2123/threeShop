...
function Page() {
  ...
  const handleSubmit = (e: any) => {
    ...
    useEffect(()=>{
      ...
      try {
        ...
        const data = database.listDocuments('650816cd8feee59dcadf', '6508174fd50e00f14748');
  ...
  const deleteDocument = (DOCUMENT_ID: string) => {
    const promise = database.deleteDocument('650816cd8feee59dcadf', '6508174fd50e00f14748', DOCUMENT_ID);
