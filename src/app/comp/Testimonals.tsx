...
export default function Testimonals() {
  return (
    ...
    <div className="mx-auto text-center md:max-w-xl lg:max-w-3xl">
      <h3 className="mb-6 text-3xl text-neutral-900 font-bold">Testimonials</h3>
    ...
    <div className="grid gap-6 text-center md:grid-cols-3">
      <div className='flex justify-center'>
        <div
          className="block max-sm:w-96 rounded-lg bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30">
      ...
      <div className='flex justify-center'>
        <div
          className="block rounded-lg max-sm:w-96 bg-white shadow-lg dark:bg-neutral-700 dark:shadow-black/30">
          <div className="h-28 overflow-hidden rounded-t-lg bg-gray-400"></div>
          <div
            className="mx-auto -mt-12 w-24 overflow-hidden rounded-full border-2 border-white bg-white dark:border-neutral-800 dark:bg-neutral-800">
            <img
